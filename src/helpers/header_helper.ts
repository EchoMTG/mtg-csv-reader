...
const DEFAULT_TCGID_HEADERS: string[] = ['product id','tcgid','tcgplayer_id','tcgplayer id','productid'];
const DEFAULT_COLLECTORS_NUMBER_HEADERS: string[] = ['collectors_number','setnumber','set number','set_number','collector\'s number','collector number','collector id','card number','cardnumber'];
const DEFAULT_SET_HEADERS: string[] = ['set', 'expansion','edition'];
const DEFAULT_SET_CODE_HEADERS: string[] = ['set_code', 'code',  'set code', 'expansion code'];
...
const DEFAULT_QUANTITY_HEADERS: string[] = ['reg qty', 'quantity', 'Quantity', 'count'];
