...
const DEFAULT_SETNUMBER_HEADERS: string[] = ['setnumber','set number', 'set_number','collector number','collector id', 'card number'];
...
myHeaderHelper['set_number'] = DEFAULT_SETNUMBER_HEADERS;
